"""
Inference script for DecomNetRetinexTapetum.

Loads the best checkpoint, runs the model on all low-light test images, and
writes enhanced outputs to RESULT_DIR with the original filenames preserved.
"""
...
from config import DEVICE, TEST_LOW_DIR, CKPT_DIR, RESULT_DIR, BASE_CHANNELS, LAMBDA_INIT, LAMBDA_MAX
