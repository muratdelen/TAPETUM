...
from config import (
    ...
    EPOCHS, LR, SEED, BASE_CHANNELS, LAMBDA_INIT, CHANNEL_GATE_SCALE
)
...
def train_one_epoch(model, loader, optimizer, device):
    ...
    running = {
        ...
        "color": 0.0, "attn": 0.0, "gate": 0.0, "psnr": 0.0
    }
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        with torch.no_grad():
            ...
            lam = F.softplus(model.lambda_param).item()
